...
const WhyUsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-secondary/10">
      <div className="container mx-auto px-6 lg:px-16 xl:px-24">
        ...
        <div className="space-y-16">
          {features.map((feature, i) => (
            <div
              key={feature.title}
              className={`grid lg:grid-cols-2 gap-10 items-center transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
