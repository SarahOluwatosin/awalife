...
const Contact = () => {
  ...
  { label: 'LinkedIn', icon: Linkedin, href: c('social', 'linkedin_url', 'https://www.linkedin.com/company/awalife'), display: 'linkedin.com/company/awalife' },
  { label: 'Facebook', icon: Facebook, href: c('social', 'facebook_url', 'https://www.facebook.com/profile.php?id=61575919264554'), display: 'facebook.com/awalife' },
  { label: 'Instagram', icon: Instagram, href: c('social', 'instagram_url', 'https://www.instagram.com/awalife_es'), display: 'instagram.com/awalife_es' }];
