          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div variants={fadeInLeft}>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button variant="outline" size="lg" asChild><a href="https://sozcccgyuxirnesfzlfn.supabase.co/storage/v1/object/public/media/resources/1771013290352-bha0kp.pdf" target="_blank" rel="noopener noreferrer" download><Download className="mr-2 w-4 h-4" />Download the sample report</a></Button>
              </div>
            </motion.div>
      ...
      <motion.section className="py-16 lg:py-20 bg-card/50" initial="hidden" whileInView="visible" viewport={viewportOnce} variants={sectionVariants}>
        <div className="container mx-auto px-6 lg:px-16 xl:px-24">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">{c('species', 'title', 'Supporting Species from Small Mammals to')} <span className="gradient-text">Large Animals</span></h2>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div variants={fadeInLeft}>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">{c('low_volume', 'title', 'Only 10 μL Blood samples Required for')} <span className="gradient-text">CBC Testing</span></h2>
