        ...
        <div className="container mx-auto px-6 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div variants={fadeInLeft}>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">{c('overview', 'title', 'Standardized Urine Sediment Review')} - <span className="gradient-text">{c('overview', 'title_highlight', 'Images and Counts')}</span> {c('overview', 'title_suffix', 'in One Workflow')}</h2>
      ...
      <motion.section className="py-16 lg:py-20 bg-white" initial="hidden" whileInView="visible" viewport={viewportOnceSmall} variants={sectionVariants}>
        <div className="container mx-auto px-6 lg:px-16 xl:px-24">
          <GsapReveal direction="up" distance={40} className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">{c('classification', 'title', 'Make Urine Sediment')} <span className="gradient-text">{c('classification', 'title_highlight', 'Consistent')}</span>{c('classification', 'title_suffix', ' - across Users and Sites')}</h2>
            ...
            <div className="mt-6">
              <Button variant="outline" size="lg" asChild>
                <a href={c('classification', 'sample_report_url', 'https://sozcccgyuxirnesfzlfn.supabase.co/storage/v1/object/public/media/resources/1771013094726-jpuaxn.pdf')} target="_blank" rel="noopener noreferrer" download><Download className="mr-2 w-4 h-4" />{c('classification', 'download_report_label', 'Download the sample report')}</a>
              </Button>
            </div>
          </GsapReveal>
        ...
        <div className="container mx-auto px-6 lg:px-16 xl:px-24">
          <div className="space-y-8">
            <motion.div className="text-center max-w-4xl mx-auto" variants={fadeInLeft}>
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">{c('how_it_works', 'title', 'From Sample to Report')} <span className="gradient-text">{c('how_it_works', 'title_highlight', 'in Under 10 minutes')}</span>{c('how_it_works', 'title_suffix', '')}</h3>
