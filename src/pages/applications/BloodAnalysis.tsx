        ...
        <div className="container mx-auto px-6 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div variants={fadeInLeft}>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Standardized Blood Smear Review - Images and Counts in One Workflow.</h2>
      ...
      <motion.section className="py-16 lg:py-20 bg-card/50" initial="hidden" whileInView="visible" viewport={viewportOnceSmall} variants={sectionVariants}>
        <div className="container mx-auto px-6 lg:px-16 xl:px-24">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">Deeper Blood Morphology Classification - Built for Clinical Review</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <motion.div className="space-y-6" variants={fadeInRight}>
              ...
              <ul className={`space-y-4 ${bodyTextClass} text-muted-foreground`}>
                <li className="flex items-start gap-3"><span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-primary/10 text-primary"><Check className="h-4 w-4" /></span><span>10μL blood, allows instant capture of 200,000 to 500,000 cells, with full reports.</span></li>
                <li className="flex items-start gap-3"><span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-primary/10 text-primary"><Check className="h-4 w-4" /></span><span>Nano-precision optic swiftly captures 1000+ fields within 8 minutes.</span></li>
              </ul>
            </motion.div>
          </div>
        </div>
