        ...
        <div className="container mx-auto px-6 lg:px-16 xl:px-24">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {stats.map((stat) => (
                <div key={stat.label} className="group relative text-center p-6 rounded-2xl bg-secondary/30 border border-border/30 hover:border-primary/30 transition-colors">
